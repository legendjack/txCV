...
public:
        ...
        bool usart3_send(uint8_t stop_flag, uint8_t direction, uint8_t speed);
private:
         int fd ;
...
bool Serialport::usart3_send(uint8_t stop_flag, uint8_t direction, uint8_t speed)
{
  int a;
  uint8_t data_temp[7];
  data_temp[0] = 0xab;
  data_temp[1] = 0xac;
  data_temp[2] = stop_flag;
  data_temp[3] = direction;
  data_temp[4] = speed;
  data_temp[5] = 0xfb;
  data_temp[6] = 0xfc;
